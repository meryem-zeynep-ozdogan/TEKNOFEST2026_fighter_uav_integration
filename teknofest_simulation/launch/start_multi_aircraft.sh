...
TEKNOFEST_WS="$HOME/teknofest_ws/src/teknofest_simulation"
...
start_gazebo() {
    ...
    # Model path'i ayarla
    export GZ_SIM_RESOURCE_PATH="${TEKNOFEST_MODELS}:${PX4_DIR}/Tools/simulation/gz/models:${PX4_DIR}/Tools/simulation/gz/worlds"
